...
# Server-side RQ2 diagnostic: compare native compressed-memory geometry across
# target decoders. This complements perturbation sensitivity by describing the
# native memory manifold itself.
